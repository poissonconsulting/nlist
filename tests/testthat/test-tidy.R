...
"vctrs_vctr")), estimate = numeric(0), sd = numeric(0), zscore = numeric(0), 
    lower = numeric(0), upper = numeric(0), svalue = numeric(0)), row.names = integer(0), class = c("tbl_df", 
"tbl", "data.frame")))
  expect_identical(tidy(nlists(nlist(x = 2))), structure(list(term = structure("x", class = c("term", "vctrs_vctr"
...
"vctrs_vctr")), estimate = c(2, 3, 4), sd = c(NA_real_, NA_real_, 
...
"vctrs_vctr")), estimate = c(1, 1, 2), sd = c(NA_real_, NA_real_, 
...
"vctrs_vctr")), estimate = c(1, 2, 3), sd = c(0, 1.4142135623731, 
