...
test_that("print.nlists",{
  ...
  expect_identical(capture.output(print(nlists)),
                   c("$x", "[1] 1", "", "$y", "     [,1] [,2]", "[1,]    1    3", 
"[2,]    2    4", "", "an nlists object of 2 nlist objects of length 2"))
})
