...
test_that("pars.nlist", {
  ...
  expect_identical(pars(nlist(x = 1, a = 1:10), scalar_only = TRUE), "x")
  expect_identical(pars(nlist(x = 1, a = 1:10), terms = TRUE), 
...
test_that("pars.nlists", {
  ...
  expect_identical(pars(nlists(nlist(x = 1, a = 1:10),
                               nlist(x = 1, a = 1:10))), c("x", "a"))
})
