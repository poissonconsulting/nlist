...
test_that("c.nlists", {
  ...
  expect_error(c(nlists(), list()),
    "^All elements of ... must inherit from S3 class 'nlists'[.]", class = "chk_error")
  expect_error(c(nlists(nlist(x = 1)),
    nlists(nlist(y = 1))),
  "^nlist elements of [.][.][.] must have matching names[.]$", class = "chk_error")
})
...
test_that("c.nlists with same nchains", {
  ...
  attr(nlists2, "nchains") <- 2L
  expect_identical(c(nlists, nlists2),
    structure(list(structure(list(x = 1), class = "nlist"), structure(list(
      x = 3), class = "nlist"), structure(list(x = 2), class = "nlist"),
...
test_that("c.nlists with same nchains", {
  ...
  expect_identical(c(nlists, nlists2),
    structure(list(structure(list(x = 1), class = "nlist"), structure(list(
      x = 2), class = "nlist"), structure(list(x = 5), class = "nlist"),
    ...
    structure(list(x = 8), class = "nlist")), class = "nlists", nchains = 2L))
})
