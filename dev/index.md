...
converted to [`coda::mcmc`](https://rdrr.io/pkg/coda/man/mcmc.html) and
...
function can be used to aggregate an `nlists` object to an `nlist`
object.
...
while the [`tidy()`](https://generics.r-lib.org/reference/tidy.html)
function treats the values as if they are MCMC samples and summarises
the terms as a tidy tibble.
